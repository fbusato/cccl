...
#ifndef _CUDAX___SIMD_LOAD_STORE_H
#define _CUDAX___SIMD_LOAD_STORE_H
...
__partial_load_from_ptr(const _Up* __ptr, __simd_size_type __count, const typename _Result::mask_type& __mask)
{
  ...
  ::cuda::experimental::simd::__assert_load_store_alignment<_Result, _Up, _Flags...>(__ptr);
  _Result __result{};
  ...
  const typename basic_vec<_Tp, _Abi>::mask_type& __mask)
{
  ...
  ::cuda::experimental::simd::__assert_load_store_alignment<basic_vec<_Tp, _Abi>, _Up, _Flags...>(__ptr);
  _CCCL_PRAGMA_UNROLL_FULL()
  ...
  flags<_Flags...> = {})
{
  ...
  return ::cuda::experimental::simd::__partial_load_from_ptr<_Result, _Up, _Flags...>(
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::ranges::range_value_t<_Range>>;
  return ::cuda::experimental::simd::partial_load<_Vp>(
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::iter_value_t<_Ip>>;
  return ::cuda::experimental::simd::partial_load<_Vp>(__first, __n, typename _Result::mask_type(true), __f);
}
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::iter_value_t<_Ip>>;
  return ::cuda::experimental::simd::partial_load<_Vp>(__first, __last, typename _Result::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  _CCCL_ASSERT(::cuda::std::cmp_greater_equal(::cuda::std::ranges::size(__r), _Result::size()),
               "unchecked_load requires ranges::size(r) >= V::size()");
  return ::cuda::experimental::simd::partial_load<_Vp>(::cuda::std::forward<_Range>(__r), __mask, __f);
}
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::ranges::range_value_t<_Range>>;
  return ::cuda::experimental::simd::unchecked_load<_Vp>(
    ::cuda::std::forward<_Range>(__r), typename _Result::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  return ::cuda::experimental::simd::partial_load<_Vp>(__first, __n, __mask, __f);
}
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::iter_value_t<_Ip>>;
  return ::cuda::experimental::simd::unchecked_load<_Vp>(__first, __n, typename _Result::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  return ::cuda::experimental::simd::partial_load<_Vp>(__first, __last, __mask, __f);
}
...
{
  using _Result = __load_vec_t<_Vp, ::cuda::std::iter_value_t<_Ip>>;
  return ::cuda::experimental::simd::unchecked_load<_Vp>(__first, __last, typename _Result::mask_type(true), __f);
}
  ...
  flags<_Flags...> = {})
{
  ...
  using _Up = ::cuda::std::ranges::range_value_t<_Range>;
  ::cuda::experimental::simd::__partial_store_to_ptr<_Tp, _Abi, _Up, _Flags...>(
...
{
  ::cuda::experimental::simd::partial_store(
...
{
  ::cuda::experimental::simd::partial_store(__v, __first, __n, typename basic_vec<_Tp, _Abi>::mask_type(true), __f);
}
...
{
  ::cuda::experimental::simd::partial_store(__v, __first, __last, typename basic_vec<_Tp, _Abi>::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  _CCCL_ASSERT(::cuda::std::cmp_greater_equal(::cuda::std::ranges::size(__r), __v.size),
               "unchecked_store requires ranges::size(r) >= V::size()");
  ::cuda::experimental::simd::partial_store(__v, ::cuda::std::forward<_Range>(__r), __mask, __f);
}
...
{
  ::cuda::experimental::simd::unchecked_store(
    __v, ::cuda::std::forward<_Range>(__r), typename basic_vec<_Tp, _Abi>::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  ::cuda::experimental::simd::partial_store(__v, __first, __n, __mask, __f);
}
...
_CCCL_API constexpr void unchecked_store(
  const basic_vec<_Tp, _Abi>& __v, _Ip __first, ::cuda::std::iter_difference_t<_Ip> __n, flags<_Flags...> __f = {})
{
  ::cuda::experimental::simd::unchecked_store(__v, __first, __n, typename basic_vec<_Tp, _Abi>::mask_type(true), __f);
}
  ...
  flags<_Flags...> __f = {})
{
  ...
  ::cuda::experimental::simd::partial_store(__v, __first, __last, __mask, __f);
}
...
{
  ::cuda::experimental::simd::unchecked_store(__v, __first, __last, typename basic_vec<_Tp, _Abi>::mask_type(true), __f);
}
} // namespace cuda::experimental::simd

#include <cuda/std/__cccl/epilogue.h>

#endif // _CUDAX___SIMD_LOAD_STORE_H
