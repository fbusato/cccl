...
_CCCL_API constexpr void __check_load_preconditions(const _Up* __ptr, flags<_Flags...>) noexcept
{
...
template <typename _Result, typename _Up, typename... _Flags>
[[nodiscard]] _CCCL_API constexpr _Result __partial_load_from_ptr(
  const _Up* __ptr,
...
__full_load_from_ptr(const _Up* __ptr, const typename _Result::mask_type& __mask, flags<_Flags...> __flags) noexcept
{
  ...
  return ::cuda::std::simd::__partial_load_from_ptr<_Result>(__ptr, _Result::size, __mask, __flags);
}
